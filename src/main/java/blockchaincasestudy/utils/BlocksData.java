...
public class BlocksData {
  ...
  private static final ZonedDateTime date =
      ZonedDateTime.of(2015, 6, 22, 14, 21, 0, 0, ZoneId.of("Europe/London"));
  ...
  private static final double[] amounts = {
    103.27, 66.54, -21.09, 44.65, 177.99, 189.02, 17.00, 32.99, 60.00, -10.00
  };
